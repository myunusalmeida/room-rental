<?php
    ...
    $sum_histories = mysqli_fetch_assoc(mysqli_query($conn, "SELECT SUM(total_price) AS total_income FROM histories WHERE MONTH(book_end_date) = '$month'"));
?>

<section class="main-content">
    <div class="container">
        <div class="row align-items-center justify-content-between">
            <h3 class="col">Income in <?= $monthName ?></h3>
                ...
                <div class="table-responsive">
                    <table class="table">
                        ...
                        <tbody>
                            <?php
                                $no = 1;
                                $histories = mysqli_query($conn, "SELECT * FROM histories WHERE MONTH(book_end_date) = '$month'");
